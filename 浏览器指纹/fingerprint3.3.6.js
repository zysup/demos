...
function h(e, n) {
  ...
  return (
    (i = l((i = f(i, [0, e.length])), (a = f(a, [0, e.length])))),
    (a = l(a, i)),
    (i = l((i = v(i)), (a = v(a)))),
    (a = l(a, i)),
              ...
              return new Promise(function (e) {
                ...
                a(i, function () {
                  for (var t = [], r = 0; r < arguments.length; r++)
                    t[r] = arguments[r];
                  var i = o + Date.now() - n;
                  if (!t[0]) return e({ error: L(t[1]), duration: i });
    ...
    return (function (e, n) {
      ...
      return M(function (t, o) {
        ...
        (c.width = n + "px"),
          ...
          S()
            ? (a.style.zoom = "" + 1 / o.devicePixelRatio)
            : F() && (a.style.zoom = "reset");
        var u = i.createElement("div");
        return (
          (u.textContent = r(Array((n / 20) << 0))
            .map(function () {
              return "word";
            })
            .join(" ")),
      ...
      return t(this, function (e) {
        switch (e.label) {
          case 0:
            return [4, ie(o)];
          case 1:
            return e.sent(), [2, ae(V(ne, { debug: i }, []), i)];
        }
      });
    })
  );
